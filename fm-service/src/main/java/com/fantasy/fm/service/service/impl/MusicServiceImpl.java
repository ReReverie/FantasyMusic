...
import com.fantasy.fm.common.constant.RedisCacheConstant;
import com.fantasy.fm.common.constant.SystemConstant;
import com.fantasy.fm.common.exception.MusicFileUploadException;
import com.fantasy.fm.common.utils.OSSUtil;
import com.fantasy.fm.common.utils.RedisCacheUtil;
...
import com.fantasy.fm.pojo.domain.entity.MusicListTrack;
import com.fantasy.fm.pojo.domain.query.MusicPageQuery;
import com.fantasy.fm.pojo.domain.vo.MusicVO;
import com.fantasy.fm.service.mapper.MusicListTrackMapper;
import com.fantasy.fm.service.mapper.MusicManagerMapper;
import com.fantasy.fm.service.mapper.MusicMapper;
...
public class MusicServiceImpl extends ServiceImpl<MusicMapper, Music> implements MusicService {
    ...
    public void saveFileInfo(File musicFile, String fileHash, String ossUrl) {
        ...
        //将音乐信息索引到ES中
        try {
            //处理音乐信息，构建一个包含所有字段的 Map，并添加 suggest 字段
            Map<String, Object> doc = getStringObjectMap(musicInfo);
    ...
    private @NonNull Map<String, Object> getStringObjectMap(Music music) {
        Map<String, Object> document = new HashMap<>();
        document.put("id", music.getId());
        document.put("title", music.getTitle());
        document.put("artist", music.getArtist());
        document.put("album", music.getAlbum());
        document.put("durationMs", music.getDurationMs());
        document.put("releaseYear", music.getReleaseYear());
        document.put("coverUrl", music.getCoverUrl());

        // 添加 suggest 字段
        List<String> suggestInputs = new ArrayList<>();
        if (music.getTitle() != null) suggestInputs.add(music.getTitle());
        if (music.getArtist() != null) suggestInputs.add(music.getArtist());
        if (music.getAlbum() != null) suggestInputs.add(music.getAlbum());
        document.put("suggest", suggestInputs);
        return document;
    }
