...
import com.fantasy.fm.exception.OperationPermissionDeniedException;
...
public class AutoPermissionCheckAspect {
    ...
    // 指定切入点
    @Pointcut("@annotation(com.fantasy.fm.annotation.AutoPermissionCheck)")
